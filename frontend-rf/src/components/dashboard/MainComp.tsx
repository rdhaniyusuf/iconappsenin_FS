...
import { Card, 
    ...
    Selection,
    ChipProps,
    SortDescriptor, } from "@heroui/react";
            ...
            {topCardList.map((item, index) => (
                <Card key={index} isPressable shadow="sm" onPress={() => console.log("item pressed")}>
                    ...
                    <CardFooter className="text-small justify-between">
                        <b>{item.title}</b>
                        <Chip className="rounded-lg items-center" color={item.color as "danger" | "warning" | "default" | "success" | "primary" | "secondary"} startContent={<item.icon size={16}/>} variant="flat">
                            {item.count}
                        </Chip>
                    </CardFooter>
                </Card>
...
const INITIAL_VISIBLE_COLUMNS = ["name", "clockIn","clockOut","status", "actions"];
